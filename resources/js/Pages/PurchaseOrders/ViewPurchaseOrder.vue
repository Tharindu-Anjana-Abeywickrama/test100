        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <button @click="bulkExport('excel')" class="bg-blue-500 text-white px-4 py-2 rounded mr-2">
                        <i class="fas fa-file-excel"></i> Export Selected to Excel
                    </button>
                    <button @click="bulkExport('pdf')" class="bg-red-500 text-white px-4 py-2 rounded">
